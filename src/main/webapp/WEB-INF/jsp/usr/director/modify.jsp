	...
	<div class="bg-white shadow-md rounded container mx-auto p-8 mt-8">
		<form onsubmit="MemberModify__checkAndSubmit(this); return false;" action="doModify" method="POST">
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">${director.loginId}</div>
			</div>
			<div class="form-row flex flex-col lg:flex-row">
				<div class="lg:flex lg:items-center lg:w-28">
					<span>비밀번호</span>
				...
				<div class="lg:flex-grow">
					<input type="password" name="loginPw" autofocus="autofocus"
						class="form-row-input w-full rounded-sm" placeholder="비밀번호를 입력해주세요." />						
				</div>
			</div>
			<div class="form-row flex flex-col lg:flex-row">
				<div class="lg:flex lg:items-center lg:w-28">
				...
				<div class="lg:flex-grow">
					<input type="password" name="loginPwConfirm" autofocus="autofocus"
						class="form-row-input w-full rounded-sm" placeholder="비밀번호를 확인해주세요." />						
				</div>
			</div>
			<div class="form-row flex flex-col lg:flex-row">
				<div class="lg:flex lg:items-center lg:w-28">
				...
				<div class="lg:flex-grow">
					<input value="${director.name}" type="text" name="name" autofocus="autofocus"
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input value="${director.nickname}" type="text" name="nickname" autofocus="autofocus"
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input value="${director.email}" type="email" name="email" autofocus="autofocus"
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input value="${director.cellphoneNo}" type="text" name="cellphoneNo" autofocus="autofocus"
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					...
					<script>
						const directorAuthLevel = parseInt("${director.authLevel}");
						$('.section-1 .select-auth-level').val(directorAuthLevel);
					</script>						
				</div>
			</div>
			<div class="form-row flex flex-col lg:flex-row">
