	...
	<div class="bg-white shadow-md rounded container mx-auto p-8 mt-8">
		<form onsubmit="MemberModify__checkAndSubmit(this); return false;" action="doModify" method="POST">
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">${client.loginId}</div>
			</div>
			<div class="form-row flex flex-col lg:flex-row">
				<div class="lg:flex lg:items-center lg:w-28">
					<span>비밀번호</span>
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input value="${client.name}" type="text" name="name" autofocus="autofocus"
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input value="${client.nickname}" type="text" name="nickname" autofocus="autofocus"
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input value="${client.email}" type="email" name="email" autofocus="autofocus"
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input value="${client.cellphoneNo}" type="text" name="cellphoneNo" autofocus="autofocus"
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					...
					<script>
						const clientAuthLevel = parseInt("${client.authLevel}");
						$('.section-1 .select-auth-level').val(clientAuthLevel);
					</script>						
				</div>
			</div>
			<div class="form-row flex flex-col lg:flex-row">
